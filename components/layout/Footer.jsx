      ...
      <Container>
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/about" className="text-sm hover:text-accent-orange transition-colors">
                    About Us
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="mailto:info@kascom.com" className="text-sm hover:text-accent-orange transition-colors">
                    info@kascom.com
                  </a>
                </li>
                <li>
          ...
          <div className="pt-8 border-t border-primary-600 text-center">
            <p className="text-sm text-primary-400">
              © 2024 KASCOM. All rights reserved.
            </p>
          </div>
        </div>
      </Container>
