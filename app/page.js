...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-radial relative">
      {/* Global Corner Glows - Unified across entire page */}
      <div className="fixed top-0 left-0 w-[600px] h-[600px] bg-accent-yellow/8 rounded-full blur-3xl -translate-x-1/3 -translate-y-1/3 pointer-events-none"></div>
      <div className="fixed top-1/4 right-0 w-[700px] h-[700px] bg-accent-orange/8 rounded-full blur-3xl translate-x-1/3 pointer-events-none"></div>
      <div className="fixed bottom-1/3 left-0 w-[650px] h-[650px] bg-accent-orange/8 rounded-full blur-3xl -translate-x-1/3 pointer-events-none"></div>
      <div className="fixed bottom-0 right-0 w-[600px] h-[600px] bg-accent-yellow/8 rounded-full blur-3xl translate-x-1/3 translate-y-1/3 pointer-events-none"></div>
